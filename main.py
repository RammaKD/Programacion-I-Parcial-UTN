...
def ejecutar_menu_principal(lista_pacientes: list[dict], lista_grupos_sanguineos: list, path_csv: str, path_json_ultimo_id: str):
    ...
    while continuar:
        ...
        match opcion:
            ...
            case 3:
                print(gestionar_eliminacion(lista_pacientes, 4000000, 99999999, 5))
            case 4:
            ...
            case 8:
                print(gestionar_compatibilidad(lista_pacientes, lista_diccionarios_compatibilidad, 4000000, 99999999, 5))
            case 9:
                system("cls")
...
ejecutar_menu_principal(lista_pacientes, lista_grupos_sanguineos, path_csv, path_json_ultimo_id)
